...
export const seedPlayers = [
  { id: "p1", firstName: "Carlos", lastName: "Martinez", nickname: "Carlitos", age: 28, hand: "right", backhand: "two", password: "1234", email: "carlos@mail.com", photo: "", approved: true, suspended: false, sanctions: [], joinedAt: dB(120) },
  { id: "p2", firstName: "Pablo", lastName: "Garcia", nickname: "Pablito", age: 31, hand: "right", backhand: "one", password: "1234", email: "pablo@mail.com", photo: "", approved: true, suspended: false, sanctions: [], joinedAt: dB(120) },
  { id: "p3", firstName: "Miguel", lastName: "Lopez", nickname: "Migue", age: 26, hand: "left", backhand: "two", password: "1234", email: "miguel@mail.com", photo: "", approved: true, suspended: false, sanctions: [], joinedAt: dB(115) },
  { id: "p4", firstName: "Javier", lastName: "Fernandez", nickname: "Javi", age: 34, hand: "right", backhand: "two", password: "1234", email: "javi@mail.com", photo: "", approved: true, suspended: false, sanctions: [], joinedAt: dB(110) },
  { id: "p5", firstName: "Daniel", lastName: "Ruiz", nickname: "Dani", age: 29, hand: "right", backhand: "one", password: "1234", email: "dani@mail.com", photo: "", approved: true, suspended: false, sanctions: [], joinedAt: dB(108) },
  { id: "p6", firstName: "Adrian", lastName: "Moreno", nickname: "Adri", age: 27, hand: "left", backhand: "two", password: "1234", email: "adri@mail.com", photo: "", approved: true, suspended: false, sanctions: [], joinedAt: dB(105) },
  { id: "p7", firstName: "Sergio", lastName: "Jimenez", nickname: "Sergi", age: 30, hand: "right", backhand: "two", password: "1234", email: "sergi@mail.com", photo: "", approved: true, suspended: false, sanctions: [], joinedAt: dB(100) },
  { id: "p8", firstName: "Alvaro", lastName: "Diaz", nickname: "Alva", age: 25, hand: "right", backhand: "one", password: "1234", email: "alva@mail.com", photo: "", approved: true, suspended: false, sanctions: [], joinedAt: dB(98) },
  { id: "p9", firstName: "Raul", lastName: "Hernandez", nickname: "Rauli", age: 33, hand: "right", backhand: "two", password: "1234", email: "raul@mail.com", photo: "", approved: true, suspended: false, sanctions: [], joinedAt: dB(95) },
  { id: "p10", firstName: "Lucas", lastName: "Sanchez", nickname: "Luqui", age: 24, hand: "left", backhand: "two", password: "1234", email: "lucas@mail.com", photo: "", approved: true, suspended: false, sanctions: [], joinedAt: dB(90) },
];
